...
candidates = (
    ...
    + [
        "getSLP", "getSLV", "getSLT", "getSLF", "getSLO", "getSLE", "getSLD",
        "getWFC", "getWFL", "getWIP", "getWGW", "getEIP", "getEGW", "getMAC2",
        "getPRN", "getCNO", "getALM", "getLTV", "getFLO", "getDBT", "getRTC",
        "getTMZ", "getDST", "getBUZ", "getDMA", "getTMP", "getALA", "getVLV",
    ]
)

cache = {name: json.loads((base / f).read_text(encoding="utf-8")) for name, f in fixtures.items()}
